...
```
git clone https://github.com/kzima/angular-fire-seed.git
cd angular-fire-seed
```
...
app/                    --> all of the source files for the application
  ...
  account/                --> the view2 view template and logic
    account.html          --> the partial template
    account.js            --> the controller logic
    accoun_testt.js       --> tests of the controller
